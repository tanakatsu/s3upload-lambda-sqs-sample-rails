...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { memo: @picture.memo, thumb_created: @picture.thumb_created } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { memo: @picture.memo, thumb_created: @picture.thumb_created } }
